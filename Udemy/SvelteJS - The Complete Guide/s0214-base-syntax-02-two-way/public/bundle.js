...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 41, 0, 626);
    			add_location(button0, file, 42, 0, 675);
    			add_location(button1, file, 43, 0, 727);
    			attr_dev(input, "type", "text");
    			input.value = /*name*/ ctx[0];
    			add_location(input, file, 44, 0, 780);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				...
    				listen_dev(input, "input", /*nameInput*/ ctx[5], false, false, false)
    			];
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function changeName() {
    		...
    		} else if (name === "Maximilian") {
    			$$invalidate(0, name = "Max");
    		} else {
    			$$invalidate(0, name = "Tarso");
    		}
    	}
    	...
    	return [name, age, uppercaseName, incrementAge, changeName, nameInput];
    }
