    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 64, 6, 1007);
    			attr_dev(div0, "class", "thumb svelte-fxhwaq");
    			add_location(div0, file, 63, 4, 981);
    			attr_dev(h1, "class", "svelte-fxhwaq");
    			add_location(h1, file, 67, 6, 1093);
    			attr_dev(h2, "class", "svelte-fxhwaq");
    			add_location(h2, file, 68, 6, 1119);
    			attr_dev(div1, "class", "user-data svelte-fxhwaq");
    			add_location(div1, file, 66, 4, 1063);
    			attr_dev(header, "class", "svelte-fxhwaq");
    			add_location(header, file, 62, 2, 968);
    			add_location(p, file, 72, 4, 1194);
    			attr_dev(div2, "class", "description svelte-fxhwaq");
    			add_location(div2, file, 71, 2, 1164);
    			attr_dev(div3, "class", "contact-card svelte-fxhwaq");
    			add_location(div3, file, 61, 0, 939);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 40, 0, 606);
    			add_location(button, file$1, 41, 0, 655);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$1, 44, 0, 834);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$1, 45, 0, 874);
    			attr_dev(input2, "type", "text");
    			add_location(input2, file$1, 46, 0, 915);
    			attr_dev(textarea, "rows", "3");
    			add_location(textarea, file$1, 47, 0, 956);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
