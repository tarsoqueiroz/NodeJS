...
var app = (function () {
    ...
    /* src/ContactCard.svelte generated by Svelte v3.19.2 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-y9bdid");
    			add_location(img, file, 58, 12, 962);
    			attr_dev(div0, "class", "thumb");
    			add_location(div0, file, 57, 8, 930);
    			attr_dev(h1, "class", "svelte-y9bdid");
    			add_location(h1, file, 61, 12, 1041);
    			attr_dev(h2, "class", "svelte-y9bdid");
    			add_location(h2, file, 62, 12, 1073);
    			attr_dev(div1, "class", "user-data svelte-y9bdid");
    			add_location(div1, file, 60, 8, 1005);
    			attr_dev(header, "class", "svelte-y9bdid");
    			add_location(header, file, 56, 4, 913);
    			add_location(p, file, 66, 8, 1159);
    			attr_dev(div2, "class", "description svelte-y9bdid");
    			add_location(div2, file, 65, 4, 1125);
    			attr_dev(div3, "class", "contact-card svelte-y9bdid");
    			add_location(div3, file, 55, 0, 882);
    		},
